...
export class Todo2CodeClient {
  ...
  async renderCodeChange(input: Record<string, unknown>): Promise<Record<string, unknown>> {
  ...
  async applySourcePatch(input: Record<string, unknown>): Promise<Record<string, unknown>> {
    return this.run<Record<string, unknown>>('apply_source_patch', input);
  }
  ...
  async closeCodeChange(input: Record<string, unknown>): Promise<Record<string, unknown>> {
    return this.run<Record<string, unknown>>('close_code_change', input);
  }
