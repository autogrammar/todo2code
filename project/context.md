...
- **Languages**: typescript: 79, md: 52, json: 20, python: 12, rust: 7
- **Analysis Mode**: static
- **Total Functions**: 2225
- **Total Classes**: 249
- **Modules**: 196
- **Entry Points**: 1514
...
- **Calls**: src.comparison.workspace.resolve, src.comparison.workspace.git, src.comparison.workspace.trim, src.comparison.workspace.relative, src.comparison.workspace.startsWith, src.comparison.workspace.isAbsolute, src.comparison.workspace.Error, src.comparison.workspace.defaultBaseRef
...
### src.diff.reality.renderRealitySvg
- **Calls**: src.diff.reality.max, src.diff.reality.min, src.diff.reality.trunc, src.diff.reality.trim, src.diff.reality.filter, src.diff.reality.slice, src.diff.reality.ceil, src.diff.reality.widestLabel
...
- **Methods**: 4
- **Key Methods**: sdk.python.todo2code.client.IntentRecord.from_dict, sdk.python.todo2code.client.IntentRecord.action, sdk.python.todo2code.client.IntentRecord.source_kind, sdk.python.todo2code.client.IntentRecord.confidence
...
### src.extractors.ast.parsed
- **Output to**: src.extractors.ast.adapterRecords
...
### src.diff.git.parseNameStatus
- **Output to**: src.diff.git.split, src.diff.git.filter, src.diff.git.map, src.diff.git.startsWith, src.diff.git.Boolean

### src.communication.llm.CommunicationLlmRequiredError.validateEnrichments
- **Output to**: src.communication.llm.isArray, src.communication.llm.Error, src.communication.llm.Set, src.communication.llm.map, src.communication.llm.CommunicationLlmRequiredError.isEnrichment

### src.communication.analyzer.validateSyntheses
- **Output to**: src.communication.analyzer.Map, src.communication.analyzer.map, src.communication.analyzer.Error, src.communication.analyzer.has, src.communication.analyzer.add
...
- `src.pipeline.run.runPipeline` - 46 calls
- `src.cli.main` - 42 calls
- `src.extractors.ast.extractTypeScriptFile` - 42 calls
- `src.web.diff-ui.diffUiHtml` - 42 calls
- `src.extractors.communication.extractCommunicationIntent` - 41 calls
- `src.comparison.workspace.compareWorkspaceIntent` - 39 calls
...
- `src.comparison.workspace.temporaryParent` - 24 calls
- `src.comparison.workspace.baseWorktree` - 24 calls
...
- `src.extractors.nl-llm.NlLlmRequiredError.extractNlIntentAudited` - 20 calls
